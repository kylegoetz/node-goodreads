...
(function() {
  ...
  Goodreads = (function() {
    ...
    Goodreads.prototype.getShelves = function(userId) {
      ...
      return this.getRequest()
      .then(obj => {
        return obj.GoodreadsResponse.shelves[0].user_shelf.map(item => {
          const rv = {};
          Object.keys(item).forEach(key=>rv[key]=cleanUpXml(item[key]));
          return rv;
        });
      });
    };
      ...
      return new Promise((resolve, reject) => {
        request(this.options.path , function (error, response, body) {
          ...
          parser.parseString(body, function (err, result) {
            ...
            delete grr.Response;
            const rv = {};
            // console.log(JSON.stringify(grr));
          ...
          function cleanUpItem(item) {
            ...
            Object.keys(item).forEach(key=>{
              console.log('cleaning',key,item[key]);
