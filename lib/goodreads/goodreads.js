...
(function() {
  ...
  Goodreads = (function() {
    ...
    Goodreads.prototype.getReview = async function(reviewId) {
      this.options.path = `https://www.goodreads.com/review/show.xml?id=${reviewId}&key=${this.options.key}`;
      const response = await this.getRequest();
    ...
    Goodreads.prototype.getUserStatus = function(statusId) {
      this.options.path = `https://www.goodreads.com/user_status/show/${statusId}?format=xml&key=${this.options.key}`;
      return this.getRequest();
    }

    Goodreads.prototype.getMemberInfo = function(userId) {
      this.options.path = `https://www.goodreads.com/user/show/${userId}`;
      return this.getRequest();
    }
